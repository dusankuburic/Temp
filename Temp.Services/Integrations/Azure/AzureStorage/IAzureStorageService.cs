...
public interface IAzureStorageService
{
    ...
    Task<List<BlobDto>> ListAsync(FileType fileType, DateTime? fromDate = null, DateTime? toDate = null, string? prefix = null, CancellationToken ct = default);
    ...
    Task<BlobResponseDto> UploadImageAsync(IFormFile image, DateTime? createdAt = null, string? folder = null, CancellationToken ct = default);
    Task<BlobResponseDto> UploadDocumentAsync(IFormFile document, DateTime? createdAt = null, string? folder = null, CancellationToken ct = default);
